...
<head>
    ...
    <title>Infinity Service</title>
</head>

<body>
    <!-- Start Navigation -->
    <nav class="navbar navbar-expand-sm navbar-dark bg-secondary pl-5 fixed-top">
        <a href="index.php" class="navbar-brand">InfinityServices</a>
                ...
                <li class="nav-item">
                    <div class="dropdown mt-2 mr-2">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            <a class="dropdown-item" href="#registration">Customer Registration</a>
                            <a class="dropdown-item" href="./ServiceProvider/ServiceRegistration.php">ServiceProvider Registration</a>
                        </div>
                    </div>
                </li>
                <li class="nav-item">
                    <div class="dropdown mt-2">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            <a class="dropdown-item" href="./Customer/RequesterLogin.php">Customer Login</a>
                            <a class="dropdown-item" href="./ServiceProvider/ServiceLogin.php">ServiceProvider Login</a>
                        </div>
                    </div>
                </li>
    ...
    <header class="jumbotron back-image" style="background-image: url(images/banner.jpg);">
        <div class="myclass mainHeading">
            <h1 class="text-uppercase text-dark font-weight-bold">Welcome to InfinityServices</h1>
            <p class="font-italic">Customer's Happiness Is Our Aim</p>
            <a href="Customer/RequesterLogin.php" class="btn btn-primary mr-4">Login</a>
    ...
    <div class="container">
        ...
        <div class="jumbotron">
            <h3 class="text-center">Infinity Services</h3>
            <p>
                Infinity Services is India’s leading chain of multi-brand Electronics and Electrical service
                workshops offering
    ...
    <div class="container" id="Contact">
        ...
        <div class="row">
            ...
            <div class="col-md-4 text-center">
                ...
                InfinityServices pvt Ltd,<br>
                Nirmal Nagar , Dahisar<br>
                Mumbai - 400001<br>
                Phone: +9999665645<br>
                <a href="#" target="_blank">www.infintiyservices.com</a><br>
                <br> <br>
            </div><!-- End 2nd column -->
        </div>
    </div><!-- End Contact Us -->
        ...
        <div class="container">
            <div class="row py-3">
                ...
                <div class="col-md-6 text-right">
                    <!-- Start 2nd column -->
                    <small>Designed by RRRW &copy; 2021</small>
